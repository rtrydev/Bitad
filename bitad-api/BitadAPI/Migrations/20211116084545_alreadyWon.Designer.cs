...
namespace BitadAPI.Migrations
{
    ...
    [Migration("20211116084545_alreadyWon")]
    partial class alreadyWon
    {
            ...
            modelBuilder.Entity("BitadAPI.Models.User", b =>
                {
                    ...
                    b.Property<bool>("BannedFromRoulette")
                        .HasColumnType("bool")
                    ...
                    b.Property<DateTime?>("WorkshopAttendanceCheckDate")
                        .HasColumnType("timestamp")
